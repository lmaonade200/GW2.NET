...
namespace GW2NET.Common.Converters
{
    ...
    public sealed class ItemRestrictionCollectionConverter : IConverter<ICollection<string>, ItemRestrictions>
    {
        ...
        /// <exception cref="ArgumentNullException">The value of <paramref name="itemRestrictionConverter" /> is a null reference.</exception>
        ...
        public ItemRestrictions Convert(ICollection<string> value, object state)
        {
            ...
            {
                result = result | this.itemRestrictionConverter.Convert(s, state);
            }
