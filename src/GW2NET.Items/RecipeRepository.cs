// <copyright file="RecipeRepository.cs" company="PlaceholderCompany">
...
namespace GW2NET.Items
{
    ...
    /// </list>
    /// </remarks>
    public class RecipeRepository : CachedRepository<int, Recipe>, IRecipeRepository, IDiscoverable<int>, ICachedRepository<int, RecipeDataModel, Recipe>, ILocalizable
    {
        ...
        public RecipeRepository(HttpClient httpClient, IResponseConverter responseConverter, ICache<int, Recipe> cache, IConverter<int, int> identifiersConverter, IConverter<RecipeDataModel, Recipe> modelConverter)
        ...
        /// <inheritdoc />
        public IConverter<RecipeDataModel, Recipe> ModelConverter { get; }
