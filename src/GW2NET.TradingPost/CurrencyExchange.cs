...
namespace GW2NET.TradingPost
{
    ...
    {
        private readonly IConverter<ExchangeDataModel, Exchange> exchangeConverter;
        ...
        public CurrencyExchange(HttpClient httpClient, IResponseConverter responseConverter, IConverter<ExchangeDataModel, Exchange> exchangeConverter)
