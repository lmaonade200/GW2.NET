...
namespace GW2NET.TradingPost
{
    ...
    public sealed class ListingRepository : CachedRepository<int, Listing>, IDiscoverable<int>, ICachedRepository<int, ListingDataModel, Listing>
    {
        ...
        public ListingRepository(HttpClient httpClient, IResponseConverter responseConverter, ICache<int, Listing> cache, IConverter<int, int> identifiersConverter, IConverter<ListingDataModel, Listing> modelConverter)
        ...
        /// <inheritdoc />
        public IConverter<ListingDataModel, Listing> ModelConverter { get; }
