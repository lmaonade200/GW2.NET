...
namespace GW2NET.V2.Accounts.Characters
{
    ...
    public sealed class CharacterRepository : CachedRepository<string, Character>, IDiscoverableNew<string>, ICachedRepositoryNew<string, CharacterDataContract, Character>
    {
