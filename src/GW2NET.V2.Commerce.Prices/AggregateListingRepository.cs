...
namespace GW2NET.V2.Commerce.Prices
{
    ...
    /// </list>
    /// </remarks>
    public sealed class AggregateListingRepository : CachedRepository<int, AggregateListing>, IDiscoverable<int>, ICachedRepository<int, AggregateListingDataContract, AggregateListing>
    {
