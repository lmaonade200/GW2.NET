...
namespace GW2NET.Factories.V2
{
    ...
    public class WeaponSkinConverterFactory : ITypeConverterFactory<SkinDataModel, WeaponSkin>
    {
        public IConverter<SkinDataModel, WeaponSkin> Create(string discriminator)
        {
